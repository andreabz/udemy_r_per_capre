...
- sostituisci gli spazi con *underscore* `gsub(" ", "_", ...)`
- riassegna il risultato alle colonne. `colnames(misure) <- ...`

**Nota bene:** `<-`, scritto `<``-` è una freccia ed è come dire uguale. Prende tutto quello che è alla sua destra e lo salva in quello che sta alla sua sinistra.
...
`|>`, scritto `|``>` è la pipe di R: prende il risultato della funzione alla sua sinistra e lo scarica nel primo argomento della funzione alla sua destra.
